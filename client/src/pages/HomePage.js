...
export default function HomePage() {
  ...
  const songColumns = [
    ...
    },
    {
      ...
      renderCell: (row) => <NavLink to={`/question_selection/${row.album_id}`}>{row.album}</NavLink> // A NavLink component is used to create a link to the album page
    },
    {
      field: 'plays',
      headerName: 'Plays'
  ...
  const albumColumns = [
    {
      field: 'title',
      headerName: 'Album Title',
      renderCell: (row) => <NavLink to={`/question_selection/${row.album_id}`}>{row.title}</NavLink> // A NavLink component is used to create a link to the album page
    },
    {
      field: 'plays',
      headerName: 'Plays'
  ...
  return (
    <Container>
      ...
      <p>Created by Trini Feng, Mia Kim, Lyla Waitman and Sarah Zhang</p>
    </Container>
  );
};